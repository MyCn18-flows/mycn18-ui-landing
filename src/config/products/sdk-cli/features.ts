...
export const SDK_CLI_FEATURES: FeaturesConfig = {
    title: 'Key Features of SDK CLI',
    subtitle:
    'Discover the powerful features that make SDK CLI the ultimate solution for your needs.',
    items: [
        {
          icon: 'lightning',
