...
export const GUARDCN18_FEATURES: FeaturesConfig = {
    title: 'Key Features of GuardCn18',
    subtitle:
    'Discover the powerful features that make GuardCn18 the ultimate solution for your needs.',
    items: [
        {
          icon: 'lightning',
