...
export const CANVACN18_FEATURES: FeaturesConfig = {
    title: 'Key Features of Canvacn18',
    subtitle:
    'Discover the powerful features that make Canvacn18 the ultimate solution for your needs.',
    items: [
        {
          icon: 'lightning',
